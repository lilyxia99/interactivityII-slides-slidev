...
Read the documentation for [flex property](https://www.w3schools.com/cssref/css3_pr_flex.php), create a two columns text box. Make sure to use [flex-direction](https://www.w3schools.com/cssref/css3_pr_flex-direction.php) to make them flow in rows so that they are two columns.
